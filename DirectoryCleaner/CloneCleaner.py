###############################################################
# Project        : CloneCleaner - Directory Automation Tool
...
def directory_watcher(DirectoryName="TargetDir"):
    ...
    filename = f"CloneCleanerLog_{timestamp}.log".replace(" ", "").replace(":", "")

    with open(filename, "w") as fobj:
        Border = "-" * 54
        fobj.write(Border + "\n")
        fobj.write("This is a log file of CloneCleaner Automation Script\n")
