###############################################################
# Project        : Process Mon - Process Monitor and Logger
...
def create_log(FolderName, Data):
    ...
    FileName = os.path.join(FolderName, "Process Mon_%s.log" % (timestamp))

    with open(FileName, "w") as fobj:
        Border = "-" * 80
        fobj.write(Border + "\n")
        fobj.write("\t\tProcess Mon - Process Log\n")
...
def main():
    ...
    create_log("Process MonLogs", processes)
